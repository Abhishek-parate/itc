            ...
            <div class="flex animate-scroll">
                ...
                <div class="flex items-center space-x-8 sm:space-x-12 md:space-x-16 px-4 sm:px-8">
                    <div class="flex flex-col items-center min-w-[100px] sm:min-w-[120px] md:min-w-[140px]">
                        <div
                            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex items-center justify-center bg-gray-50 rounded-lg p-3 sm:p-4 border-2 border-gray-200">
    ...
    <section class="py-10 sm:py-10 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
                ...
                <!-- Card 1 -->
                <div
                    class="group relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer">
                    <img src="https://static3.industrybuying.com/homepage/1764246309image%20-%202025-11-27T175455.592.png"
                        alt="Floral Soaps - Get 25% Off" class="w-full h-full object-cover" loading="lazy">
                    <div
                ...
                <div
                    class="group relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer">
                    <img src="https://static3.industrybuying.com/homepage/1764246041image%20-%202025-11-27T174935.443.png"
                        alt="Soap Gift Sets - 50% Off" class="w-full h-full object-cover" loading="lazy">
                    <div
                        class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300">
                    </div>
                </div>
                ...
                <div
                    class="group relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer">
                    <img src="https://static3.industrybuying.com/homepage/1764246309image%20-%202025-11-27T175455.592.png"
                        alt="Fruit Soaps - Trending Sales" class="w-full h-full object-cover" loading="lazy">
                    <div
                        class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300">
                    </div>
                </div>
